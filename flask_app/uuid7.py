# PR on the uuid7 git repo which drops variable precision and defaults to millisecond
# author = nickhobbs94 (I used to work with a Nick Hobbs in MN!)
# https://github.com/stevesimmons/uuid7/pull/2
# https://github.com/stevesimmons/uuid7/blob/f393d27546705de8391f60407f058e3555bb6028/uuid_extensions/uuid7.py
